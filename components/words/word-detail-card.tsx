    ...
    <div className="bg-white rounded-xl border border-[#E5E7EB] p-4 md:p-5 shadow-sm">
      ...
      <div className="mb-4">
        ...
        <div className="mt-2 flex items-center gap-2">
          <span className="text-lg font-semibold text-[#111827]">{word.word}</span>
          <AudioButton size="small" label={`Play ${word.word}`} text={word.word} lang="en-US" />
        </div>
